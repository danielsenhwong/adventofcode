...
# ()()) causes him to enter the basement at character position 5.  What is the
# position of the character that causes Santa to first enter the basement?
#

# Saved puzzle input to a text file.
# Read this in, and remove the newline breaks. 
with open("day01.txt", "r") as myfile:
	day01_input = myfile.read().replace('\n', '')

# Turn the whole thing into a list.
...
for index in range(len(day01_list)):
	...
	# Part 2
	# Add 1 to the index, because character position index starts at 1, list index starts at 0
	if floor == -1:
		print 'In the basement! ' + str(index + 1)
